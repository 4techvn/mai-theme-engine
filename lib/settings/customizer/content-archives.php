...
function mai_register_customizer_content_archives_settings( $wp_customize ) {
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => absint( mai_get_default_setting( 'columns' ) ),
			'type'              => 'option',
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => sanitize_key( mai_get_default_setting( 'content_archive' ) ),
			'type'              => 'option',
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => absint( mai_get_default_setting( 'content_archive_limit' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'absint',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => mai_sanitize_one_zero( mai_get_default_setting( 'content_archive_thumbnail' ) ),
			'type'              => 'option',
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => sanitize_key( mai_get_default_setting( 'image_location' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'sanitize_key',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => sanitize_key( mai_get_default_setting( 'image_size' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'sanitize_key',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => sanitize_key( mai_get_default_setting( 'image_alignment' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'sanitize_key',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => mai_sanitize_one_zero( mai_get_default_setting( 'more_link' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'mai_sanitize_one_zero',
		)
	);
	...
	if ( post_type_supports( $post_type, 'genesis-entry-meta-before-content' ) || post_type_supports( $post_type, 'genesis-entry-meta-after-content' ) ) {
		...
		$wp_customize->add_setting(
			...
			array(
				'default'           => _mai_customizer_multicheck_sanitize_key( mai_get_default_setting( 'remove_meta' ) ),
				'type'              => 'option',
	...
	$wp_customize->add_setting(
		'posts_per_page',
		array(
			'default'           => absint( mai_get_default_setting( 'posts_per_page' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'absint',
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => sanitize_key( mai_get_default_setting( 'posts_nav' ) ),
			'type'              => 'option',
			'sanitize_callback' => 'sanitize_key',
		)
	);
